export default function About() {
  return (
    <section id={'about'} className="md:h-screen flex items-center justify-center px-5 ">
      <div className="md:container bg-background rounded-[60px] flex flex-col-reverse md:flex-row justify-between gap-10 p-6 md:p-8 my-10">
